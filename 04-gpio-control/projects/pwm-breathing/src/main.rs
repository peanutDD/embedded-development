...
fn main() -> ! {
    ...
    rprintln!("PWM配置完成: 频率={}Hz, 最大占空比={}", PWM_FREQUENCY, max_duty);
    ...
    // 呼吸灯控制器
    let mut breathing_controller = BreathingController::new(max_duty, BREATHING_PERIOD_MS, STEPS_PER_CYCLE);
...
mod tests {
    ...
    fn test_breathing_controller() {
        ...
        assert!(matches!(controller.direction, BreathingDirection::Increasing));
