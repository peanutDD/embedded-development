...
impl UartError {
    ...
    pub fn severity(&self) -> ErrorSeverity {
        match self {
            ...
            UartError::Hardware(e) => match e {
                HardwareError::ParityError | HardwareError::FramingError | HardwareError::NoiseError => ErrorSeverity::Warning,
    ...
    pub fn is_recoverable(&self) -> bool {
        match self {
            ...
            UartError::Hardware(e) => match e {
                HardwareError::ParityError | HardwareError::FramingError | HardwareError::NoiseError => true,
...
mod tests {
    ...
    fn test_error_context() {
        let mut context = ErrorContext::new("test_function")
