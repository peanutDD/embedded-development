...
fn update_channel_leds(
    ...
    channel1_led.set_state((pwm_values.channel1 > threshold).into()).ok();
    channel2_led.set_state((pwm_values.channel2 > threshold).into()).ok();
    channel3_led.set_state((pwm_values.channel3 > threshold).into()).ok();
}
