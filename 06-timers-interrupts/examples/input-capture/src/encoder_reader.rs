...
use stm32f4xx_hal::{
    ...
    gpio::{gpioa::*, Input, PullUp, Alternate, AF1, AF2},
    interrupt,
};
...
impl DualEncoderManager {
    ...
    pub fn get_robot_linear_velocity(&self) -> f32 {
        let left_velocity = self.left_encoder.get_velocity_rpm() * core::f32::consts::PI * self.wheel_diameter / 60.0;
        let right_velocity = self.right_encoder.get_velocity_rpm() * core::f32::consts::PI * self.wheel_diameter / 60.0;
