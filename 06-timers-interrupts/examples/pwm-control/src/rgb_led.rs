...
use stm32f4xx_hal::{
    ...
    gpio::{gpioa::{PA8, PA9, PA10}, Alternate, AF1},
};
...
impl Color {
    ...
    pub fn to_rgb(&self) -> RgbColor {
        match self {
            Color::Red => RgbColor { red: 255, green: 0, blue: 0 },
            Color::Green => RgbColor { red: 0, green: 255, blue: 0 },
            Color::Blue => RgbColor { red: 0, green: 0, blue: 255 },
            Color::White => RgbColor { red: 255, green: 255, blue: 255 },
            Color::Black => RgbColor { red: 0, green: 0, blue: 0 },
            Color::Yellow => RgbColor { red: 255, green: 255, blue: 0 },
            Color::Cyan => RgbColor { red: 0, green: 255, blue: 255 },
            Color::Magenta => RgbColor { red: 255, green: 0, blue: 255 },
            Color::Orange => RgbColor { red: 255, green: 165, blue: 0 },
            Color::Purple => RgbColor { red: 128, green: 0, blue: 128 },
            Color::Pink => RgbColor { red: 255, green: 192, blue: 203 },
...
impl<R_PIN, G_PIN, B_PIN> RgbLedController<R_PIN, G_PIN, B_PIN> {
    ...
    pub fn new(
        ...
        Self {
            ...
            blue_pwm,
            max_duty,
            current_color: RgbColor { red: 0, green: 0, blue: 0 },
        }
    }
    ...
    pub fn fade_between_colors(&mut self, from: Color, to: Color, steps: u8, delay_ms: u32) {
        ...
        for step in 0..=steps {
            ...
            let green = (from_rgb.green as u16 * inv_factor + to_rgb.green as u16 * factor) / steps as u16;
