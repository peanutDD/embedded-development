...
use digital_io::{
    DigitalOutputController, OutputConfig, PinState, PinMode,
    DriveStrength, SlewRate, OutputMode,
};
...
impl OutputController {
    ...
    fn generate_spiral_pattern(&self) -> u32 {
        ...
        // 模拟8x4矩阵的螺旋模式
        let positions = [
            0, 1, 2, 3, 7, 11, 15, 19, 23, 27, 31, 30, 29, 28,
            24, 20, 16, 12, 8, 4, 5, 6, 10, 14, 18, 22, 26, 25, 21, 17, 13, 9
        ];
