...
fn demonstrate_flash_operations(spi: &mut SpiType, cs: &mut CsPin, led: &mut PC13<Output<PushPull>>) {
    // 1. Flash 初始化和识别
...
fn test_single_byte_operations(spi: &mut SpiType, cs: &mut CsPin, led: &mut PC13<Output<PushPull>>) {
...
mod flash_advanced {
    ...
    pub fn flash_write_large_data(spi: &mut SpiType, cs: &mut CsPin, start_address: u32, data: &[u8]) {
    ...
    pub fn flash_verify_data(spi: &mut SpiType, cs: &mut CsPin, address: u32, expected_data: &[u8]) -> bool {
