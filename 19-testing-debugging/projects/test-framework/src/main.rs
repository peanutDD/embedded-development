...
pub mod hal_testing {
  ...
  impl TestHardware {
    pub fn new(led: PA5<Output<PushPull>>, delay: Delay, timer: Timer<stm32::TIM2>) -> Self {
...
pub mod mock_hardware {
  ...
  impl MockGpio {
    ...
    pub fn expect_set_high(&mut self) {
      self
        .expectations
        .push(GpioTransaction::set(State::High))
        .ok();
    }
    ...
    pub fn expect_set_low(&mut self) {
      self
        .expectations
        .push(GpioTransaction::set(State::Low))
        .ok();
    }
