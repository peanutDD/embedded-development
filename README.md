...
| [第18章](18-machine-learning-ai/) | 机器学习与AI | 边缘AI、模型优化 | 智能边缘设备 |
| [第19章](19-testing-debugging/) | 测试与调试 | 单元测试、集成测试 | 测试框架 |
| [第20章](20-system-integration/) | 系统集成 | 系统集成、部署策略 | 完整产品系统 |
...
├── 📁 18-machine-learning-ai/     # 机器学习与AI
├── 📁 19-testing-debugging/     # 测试和调试
├── 📁 20-system-integration/    # 系统集成和部署
├── 📁 docs/                     # 文档和指南
├── 📁 examples/                 # 跨平台示例
├── 📁 scripts/                  # 构建和验证脚本
├── 📁 tests/                    # 集成测试
