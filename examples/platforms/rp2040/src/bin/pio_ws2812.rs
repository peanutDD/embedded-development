...
use rp2040_platform::{
    GpioManager, SystemInit, Utils, PioManager,
    debug::print_info,
};
...
impl<P> WS2812Controller<P> {
    fn new(pio: &mut rp2040_hal::pio::PIO<rp2040_hal::pac::PIO0>, 
           sm: rp2040_hal::pio::UninitStateMachine<(rp2040_hal::pac::PIO0, rp2040_hal::pio::SM0)>,
           pin: rp2040_hal::gpio::Pin<rp2040_hal::gpio::pin::bank0::Gpio2, rp2040_hal::gpio::FunctionPio0>) -> Self {
